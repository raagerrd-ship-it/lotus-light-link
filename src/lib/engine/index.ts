...
export { createAgcState, rescaleAgc, updateRunningMax, volumeToBucket, updateVolumeTable, getFloorForVolume, normalizeBand, normalizeValue, createVolumeTable, migrateToVolumeTable, quietTickThresholds, QUIET_MS_MEDIUM, QUIET_MS_FAST, type AgcState, type AgcVolumeTable } from './agc';
