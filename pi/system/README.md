...
| `LOTUS_BAND_EVERY_HOPS` | 7 (=18,67 ms, 53,6 Hz) | Paketperiod i analysator-hop (2,667 ms). 8 = 21,33 ms/46,9 Hz, 9 = 24 ms/41,7 Hz. Byts med omstart; sätt `tick-ms` (lease) strax under perioden och mät intervallet live via `PUT /api/ble/interval`. Kedje-svepet 2026-09-18. |
