...
const DEFAULT_PROFILES: Record<ProfileName, ProfileCal> = {
  Lugn:   { bassWeight: 0.7, attackAlpha: 0.061, releaseAlpha: 0.025, dynamicDamping: -1.5, brightnessFloor: 3, punchWhiteThreshold: 100, perceptualGamma: 2.2, transientGain: 0.7, dynamicsEnabled: true, onsetThreshold: 2.0, onsetRefractoryMs: 150, onsetEnergyFloor: 0.01, tickEnergyFloor: 0.01, flickerDeadband: 0.025 },
  Normal: { bassWeight: 0.8, attackAlpha: 1.0,   releaseAlpha: 0.15,  dynamicDamping: 0,    brightnessFloor: 5, punchWhiteThreshold: 100, perceptualGamma: 0.9, transientGain: 0.8, dynamicsEnabled: false, onsetThreshold: 1.8, onsetRefractoryMs: 200, onsetEnergyFloor: 0.01, tickEnergyFloor: 0.01, flickerDeadband: 0.02 },
  Party:  { bassWeight: 0.3, attackAlpha: 1.0,   releaseAlpha: 0.5,   dynamicDamping: 1.5,  brightnessFloor: 0, punchWhiteThreshold: 93,  perceptualGamma: 1.5, transientGain: 1.5, dynamicsEnabled: true, onsetThreshold: 1.6, onsetRefractoryMs: 90, onsetEnergyFloor: 0.01, tickEnergyFloor: 0.01, flickerDeadband: 0.005 },
  Custom: { bassWeight: 0.5, attackAlpha: 1.0,   releaseAlpha: 0.025, dynamicDamping: 0,    brightnessFloor: 0, punchWhiteThreshold: 100, perceptualGamma: 0,   transientGain: 0.5, dynamicsEnabled: true, onsetThreshold: 3.0, onsetRefractoryMs: 110, onsetEnergyFloor: 0.01, tickEnergyFloor: 0.01, flickerDeadband: 0.02 },
