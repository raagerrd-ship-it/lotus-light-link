...
export { sendToBLE, sendRawColor, sendIdleForce, resetLastSent, setDimmingGamma, getDimmingGamma, getMinWriteIntervalMs, setMinWriteIntervalMs, stopKeepAlive } from './protocol.js';
